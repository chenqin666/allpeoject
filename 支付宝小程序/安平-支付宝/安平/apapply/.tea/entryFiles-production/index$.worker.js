...
require('../../pages/mainsucess/mainsucess');
require('../../pages/cards/cards');
require('../../pages/helps/helps');
require('../../pages/searchall/searchall');
require('../../pages/hhh/hhh');
require('../../pages/images/images');
require('../../pages/recharge/recharge');
require('../../pages/dingdetail/dingdetail');
require('../../pages/details/details');
require('../../pages/losscard/losscard');
require('../../pages/changepsd/changepsd');
require('../../pages/cardsearch/cardsearch');
}
