...
const formatstarthalfYearDate = date => {
  var dd = new Date();
  dd.setDate(dd.getDate()-180);//获取AddDayCount天后的日期 
  var y = dd.getFullYear();
  var m = dd.getMonth() + 1+1;//获取当前月份的日期 
  var d = dd.getDate();
  return y + "-" + m ;
}
...
module.exports = {
  ...
  formatDateYearMonth: formatDateYearMonth,
  formatstarthalfYearDate: formatstarthalfYearDate,
}
